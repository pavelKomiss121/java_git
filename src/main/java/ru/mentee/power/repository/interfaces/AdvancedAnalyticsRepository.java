...
public interface AdvancedAnalyticsRepository {
   ...
   * @throws DataAccessException при ошибках доступа к данным
   */
  List<TimeSeriesAnalysis> getTimeSeriesAnalysis(
  ...
  List<CohortAnalysisAdvanced> getAdvancedCohortAnalysis(
      LocalDate cohortStartMonth, Integer maxPeriods
  ) throws DataAccessException;
   ...
   * @throws DataAccessException при ошибках доступа к данным
   */
  List<SalesFunnelAnalysis> getSalesFunnelAnalysis(
      LocalDate startDate, LocalDate endDate
  ) throws DataAccessException;
   ...
   * @throws DataAccessException при ошибках доступа к данным
   */
  List<SalesForecast> getSalesForecast(
      Integer historicalMonths, Integer forecastMonths
  ) throws DataAccessException;
}