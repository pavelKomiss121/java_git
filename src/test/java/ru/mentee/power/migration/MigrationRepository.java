...
public class MigrationRepository implements MigrationValidator{
  ...
  final static String SQL_VALIDATE_TABLES = """
      SELECT
  ...
  final static String SQL_VALIDATE_KEYS = """
      SELECT
        ( EXISTS (
  ...
  final static String SQL_VALIDATE_INDEXES = """
      SELECT
  ...
  final static String SQL_VALIDATE_DATA = """
      SELECT
  ...
  @Override
  public boolean validateSchemaStructure(PostgreSQLContainer postgres) throws DataAccessException {
    try
        (
            Connection conn = getTestConnection(postgres);
  ...
  @Override
  public boolean validateForeignKeyConstraints(PostgreSQLContainer postgres) throws DataAccessException {
    try
        (
            Connection conn = getTestConnection(postgres);
